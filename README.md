...
| ![Simple fire sensor board with easyC](https://github.com/SolderedElectronics/Simple-fire-sensor-board-with-easyC-hardware-design/blob/main/OUTPUTS/V1.1.1/333042.jpg?raw=true) |
| :----------------------------------------------------------: |
